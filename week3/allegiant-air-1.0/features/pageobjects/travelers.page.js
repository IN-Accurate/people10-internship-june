...
class Travelers {
  ...
  async selectDesignatedSeat(i) {
    ...
    // Here we are selecting a random adult's name as the designated lap
    ...
    // Remove dot from suffix and convert to uppercase
    if (suffix.endsWith('.')) {
    ...
    // Constructing an XPath to find the option in the dropdown
